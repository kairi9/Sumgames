    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recruit_gender', models.CharField(choices=[('AL', '誰でも'), ('MA', '男性'), ('FE', '女性'), ('EX', 'その他')], default='MA', max_length=2)),
                ('recruit_con', models.TextField(null=True, verbose_name='募集内容')),
        ...
        migrations.AddField(
            model_name='game',
            name='tags',
            field=models.ManyToManyField(blank=True, null=True, to='matching_app.Tags', verbose_name='タグ'),
        ),
    ]
